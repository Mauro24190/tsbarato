...
<table class=" table table-striped">
    ...
    <?php foreach($this->model->Listar() as $r): ?>
        <tr>
            ...
            <td>
                <a href="?c=proveedor&a=Crud&nit=<?php echo $r->nit; ?>"><button type="button" class="btn btn-success"><i class="bi bi-pencil-fill"></i></button></a>
            </td>
            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=proveedor&a=Eliminar&nit=<?php echo $r->nit; ?>"><button type="button" class="btn btn-danger"><i class="bi bi-trash-fill"></i></button></a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
