    ...
    <div>
        <form class="row mt-2" method="post" action="?c=usuario&a=Registrar">
            ...
            <div class="col-5 mb-3">
                ...
                <input class="form-control" type="password" name="pas_cli"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Contraseña minimo de 8 caracteres. Debe contener minimo una mayusculas                                                                                                                    " >
            </div>
            <div class="col-4">
